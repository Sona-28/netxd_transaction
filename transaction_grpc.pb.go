...
func (c *transactionServiceClient) TransferMoney(ctx context.Context, in *TransactionData, opts ...grpc.CallOption) (*TransactionResponse, error) {
	out := new(TransactionResponse)
	err := c.cc.Invoke(ctx, "/netxd_customer.TransactionService/TransferMoney", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TransactionService_TransferMoney_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/netxd_customer.TransactionService/TransferMoney",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransactionServiceServer).TransferMoney(ctx, req.(*TransactionData))
	}
...
var TransactionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "netxd_customer.TransactionService",
